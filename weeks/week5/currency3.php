...
<head>
<meta charset="UTF-8">
<title>Basic Currency 3 sticky form</title>
...
<body>
    <form action="
        ...
        <fieldset>
            ...
            <label for="bank">Choose your banking institutiom.
            </label>

            <select name="bank">
                <option value="" NULL
                <?php 
                    if(isset($_POST['bank']) && $_POST['bank'] == NULL) echo 'selected="unselected"';
                ?>
                >Select one!</option>
                <option value="BOA"
                <?php 
                ...
                <option value="key"
                <?php 
                    if(isset($_POST['bank']) && $_POST['bank'] == 'key') echo 'selected="selected"';
                ?>
                >Key Bank</option>
                <option value="chase"
                <?php 
                ...
                <?php 
                    if(isset($_POST['bank']) && $_POST['bank'] == 'mattress') echo 'selected="unselected"';
                ?>
                >Mattress</option>
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if($_POST['bank'] == NULL) {
            echo '<span class="error">Please choose your bank</span>';
        }
        ...
        if(isset(
            ...
            <div class="box">
                <h2>Hello, '.$name.',</h2>
                <p>you now have $'.$friendly_total.' American dollars, and it will be deposited in <b>'.$bank.'.</b> We will email you <b>'.$email.'</b> in the next 24 hours.</p>
            </div>
