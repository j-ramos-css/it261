<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
    <fieldset>
        ...
        <input type="text" name="first_name" placeholder="first name" value="<?php if(isset($_POST['first_name'])) echo htmlspecialchars($_POST['first_name']); ?>">
        <span class="error"><?php echo $first_name_Err; ?></span>

        <label for="last_name">Last Name</label>
        <input type="text" name="last_name" placeholder="last name" value="<?php if(isset($_POST['last_name'])) echo htmlspecialchars($_POST['last_name']); ?>">
        <span class="error"><?php echo $last_name_Err; ?></span>

        <label for="email">Email</label>
        <input type="email" name="email" placeholder="example@email.com" value="<?php if(isset($_POST['email'])) echo htmlspecialchars($_POST['email']); ?>">
        ...
        <label for="newsletter">Choose a Newsletter subscription</label>
        <ul>

            <li>
                <input type="checkbox" name="newsletter[]" value="ale"
                    <?php if(isset($_POST['newsletter']) && in_array('ale', $newsletter)) echo 'checked="checked"' ;?>>PR Cuisine Newsletter
            </li>

            <li>
                <input type="checkbox" name="newsletter[]" value="lager"
                    <?php if(isset($_POST['newsletter']) && in_array('lager', $newsletter)) echo 'checked="checked"' ;?>>PR History Newsletter
            </li>

            <li>
                <input type="checkbox" name="newsletter[]" value="stout"
                    <?php if(isset($_POST['newsletter']) && in_array('stout', $newsletter)) echo 'checked="checked"' ;?>>PR Geography Newsletter
            </li>

            <li>
                <input type="checkbox" name="newsletter[]" value="porter"
                    <?php if(isset($_POST['newsletter']) && in_array('porter', $newsletter)) echo 'checked="checked"' ;?>>PR Politics Newsletter
            </li>

            <li>
                <input type="checkbox" name="newsletter[]" value="pilsner"
                    <?php if(isset($_POST['newsletter']) && in_array('pilsner', $newsletter)) echo 'checked="checked"' ;?>>PR Night Out Newsletter
            </li>
        ...
        <label for="regions">Which region are you from?</label>
        <select name="regions">
            <option value="" NULL
        ...
        <label for="comments">Comments</label><textarea name="comments"><?php if(isset($_POST['comments'])) echo htmlspecialchars($_POST['comments']) ;?></textarea>
